...
/// A mock implementation of the GoogleOAuthProvider for testing purposes.
/// It simulates the OAuth flow without making real network requests.
class MockGoogleOAuthProvider: OAuthProvider {
    ...
    func handleRedirectURL(_ url: URL) -> Bool {
        // In a real scenario, you would parse the URL and determine if it pertains to Google OAuth.
    ...
    func signIn(presentingViewController: UIViewController) -> AnyPublisher<OAuthTokens, Error> {
        ...
        Just(MockGoogleOAuthProvider.mockTokens())
